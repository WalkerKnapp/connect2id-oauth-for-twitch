 ...
 */
@Immutable
public class TrustMarkStatusErrorResponse extends TrustMarkStatusResponse {
	 ...
	 */
	public TrustMarkStatusErrorResponse(final FederationAPIError error) {
		if (error == null) {
	...
	/**
	 * Parses a trust mark status error response from the specified HTTP
	 * response.
	 *
	 ...
	 */
	public static TrustMarkStatusErrorResponse parse(final HTTPResponse httpResponse)
		throws ParseException {
		httpResponse.ensureStatusCodeNotOK();
		return new TrustMarkStatusErrorResponse(FederationAPIError.parse(httpResponse));
	}
}
